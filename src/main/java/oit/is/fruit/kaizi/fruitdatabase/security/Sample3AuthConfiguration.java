package oit.is.fruit.kaizi.fruitdatabase.security;
...
public class Sample3AuthConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(AuthenticationManagerBuilder auth) throws Exception {
    ...
    auth.inMemoryAuthentication().withUser("c")
        .password("$2y$10$kVcMuxdsJtnoF3wnZOaxbeHvwk8sTffLfQFhvcx5zRgjVtzATOPqS").roles("CUSTOMER");
    auth.inMemoryAuthentication().withUser("s")
        .password("$2y$10$kVcMuxdsJtnoF3wnZOaxbeHvwk8sTffLfQFhvcx5zRgjVtzATOPqS").roles("SELLER");
  }
